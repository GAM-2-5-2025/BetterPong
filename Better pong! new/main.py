...
text_chosenthemeportal = text('Portal theme', 'Purple', coincounter_pos_x, 950, 75, 'n')
text_Themehalloween = text('Level:', 'Orange', coincounter_pos_x, 900, 75, 'n')
text_chosenthemehalloween = text('Halloween', 'Orange', coincounter_pos_x, 950, 75, 'n')
...
text_mThemeduck = text('Level:', (0,183,255), gamex // 2 - 100, 350, 75, 'n')
text_mchosenthemeduck = text('Duckies!!!', (0,183,255), gamex // 2 - 100, 400, 75, 'n')
text_mThememeadow = text('Level:', (28, 168, 3), gamex // 2 - 100, 350, 75, 'n')
text_mchosenthememeadow = text('Meadow lands', (28, 168, 3),  gamex // 2 - 100, 400, 75, 'n')
text_mThemeportal = text('Level:', 'Purple',  gamex // 2 - 100, 350, 75, 'n')
text_mchosenthemeportal = text('Portal theme', 'Purple',  gamex // 2 - 100, 400, 75, 'n')
text_mThemehalloween = text('Level:', 'Orange',  gamex // 2 - 100, 350, 75, 'n')
text_mchosenthemehalloween = text('Halloween', 'Orange',  gamex // 2 - 100, 400, 75, 'n')
...
text_mLeaderboard = text('Leaderboard:', 'Gold', gamex // 2 - 100, 700, 65, 'n')
text_mleaderboardpos1 = text('1. ImKarlo', 'Gold', gamex // 2 - 100, 700 + (0 + 1) * textsepparation, 65, 'n')
text_mleaderboardpos2 = text('2. Kira373', 'Gold', gamex // 2 - 100, 700 + (1 + 1) * textsepparation, 65, 'n')
text_mleaderboardpos3 = text('3. Andrej2008', 'Gold', gamex // 2 - 100, 700 + (2 + 1) * textsepparation, 65, 'n')
text_mleaderboardpos4 = text('4. AtraMartA', 'Gold', gamex // 2 - 100, 700 + (3 + 1) * textsepparation, 65, 'n')
text_mleaderboardpos5 = text('5. Tia C.', 'Gold', gamex // 2 - 100, 700 + (4 + 1) * textsepparation, 65, 'n')
...
whitecover = borders('White', gamex - 300, gamey - 300, 300, 300)
